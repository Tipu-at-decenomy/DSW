...
#define __PORT_MAINNET__ 13333
#define __PORT_TESTNET__ 14333
#define __PORT_REGTEST__ 15333
 ...
 * CryptoFlow system. There are three: the main network on which people trade goods
